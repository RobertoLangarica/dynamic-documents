<template>
  <div class="row q-col-gutter-y-sm">
    ...
    <template v-if="editMode">
      ...
      <q-checkbox
        v-model="readonly"
        label="Este campo se puede editar al momento de capturar"
      />
      ...
      <q-expansion-item
        label="Vista e impresión"
        class="col-12"
        icon="preview"
      >
        <div class="row justify-between">
          <q-checkbox
            v-model="show_in_print"
            left-label
            label="Visible en modo de captura"
          />
          <q-checkbox
            v-model="show_in_capture"
            left-label
            label="Visible en modo de impresión"
          />
        </div>
      </q-expansion-item>
      ...
      >
        <div class="col-12 row q-col-gutter-y-md">
          ...
          <!-- Label & Hint -->
          <q-expansion-item
            label="Configuración de la captura"
            class="col-12"
          >
            <div class="col-12 row justify-between">
              ...
              <q-checkbox
                v-model="required"
                left-label
                label="Campo forzosamente requerido"
              />
            </div>
          </q-expansion-item>
        </div>
